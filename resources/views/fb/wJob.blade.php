...
<html>
    <head>
        ...
        <link href="{{ secure_asset('css/wJob.css') }}" rel="stylesheet">
            ...
            <div class="big-body-main">
                ...
                <div class="body-main-3">
                    ...
                    <div class="body-button">
                        ...
                        <a href="./os" class="btn-square-shadow"><i class="fab fa-apple"></i> お仕事用アプリはコチラ <i class="fas fa-arrow-circle-right"></i></a>
                        <br>
                        <br>
