    ...
    <body>
        ...
        <div class="big-body">
            ...
            <div class="body-top">
                ...
                <a href="https://a-trade.jp/redirect/fatey-multi?media=G16531" target="_blank"><img src="{{ asset('image/lp_ad_1.JPG') }}"></a>
                <h1><span>某有名アダルト掲示板のアプリ版</span></h1>
                <a href="https://a-trade.jp/redirect/fatey-multi?media=G16531" target="_blank" class="btn-square-shadow"><i class="fab fa-apple"></i> 裏掲示板はコチラ <i class="fas fa-external-link-alt"></i></a>
            </div>
